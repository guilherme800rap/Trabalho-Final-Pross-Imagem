...
class MyWindow(QMainWindow):
    def __init__(self):
        ...
        self.setWindowTitle("Transformação de Imagens")
        self.setWindowIcon(QIcon("imagens/iconeaplicativo.jpg"))
    ...
    def criarWidgets(self):
        ...
        self.barraStatus.showMessage("Seja bem-vindo(a) ao meu aplicativo", 5000)
    ...
    def mostrarInformacoesSobre(self):
        ...
        if self.opcaoEscolhida == "S&obre o Aplicativo":
            ...
            self.caixaMensagem.setText("Criado por Guilherme Antony Souto Peres")
            self.caixaMensagem.setInformativeText("Canápolis-MG, 05 de Agosto de 2020")
            self.descricao ='Foi criado esse aplicativo para a realização de transformações em imagens com extensão pgm, ppm e pbm, com intúito de concluir o trabalho final da disciplina de Processamento Digital de Imagens no Curso Superior em Análise e Desenvolvimento de Sistemas do Instituto Federal de Educação, Ciência e Tecnologia do Triângulo Mineiro - IFTM'
    ...
    "Salva uma cópia da imagem com o nome do arquivo e diretório escolhidos pelo usuário, depois de verificar se existe"
